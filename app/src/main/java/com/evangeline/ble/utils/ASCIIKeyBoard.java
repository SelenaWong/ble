...
public class ASCIIKeyBoard extends Dialog implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_ascii_value);
        // Custom keyboard Buttons
        Button viewOk = (Button) findViewById(R.id.dialog_ascii_value_okBtn);
        Button viewCancel = (Button) findViewById(R.id.dialog_ascii_value_cancelBtn);
        mAsciivalue = (EditText) findViewById(R.id.dialog_ascii_value_asciiEdt);
        mAsciivalue.setText("");
