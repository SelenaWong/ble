...
package com.evangeline.ble.OTAFirmwareUpdate;
...
import com.evangeline.ble.activity.MainActivity;
import com.evangeline.ble.app.App;
import com.evangeline.ble.logActivity.DataLoggerActivity;
import com.evangeline.ble.model.OTAFlashRowModel;
...
import com.evangeline.ble.utils.TextProgressBar;
 ...
 * OTA update fragment
 */
public class OTAFirmwareUpgradeActivity extends BaseActivity implements View.OnClickListener, FileReadStatusUpdater {
    //Option Mapping
    ...
    //UI Elements
    @BindView(R.id.ota_upgrade_type_selection_logTv)TextView mLogTv;
    @BindView(R.id.file_status)TextView mProgressText;
    @BindView(R.id.stop_upgrade_button) Button mStopUpgradeButton;
    @BindView(R.id.upgrade_progress_bar_top) TextProgressBar mProgressTop;
    @BindView(R.id.upgrade_progress_bar_bottom) TextProgressBar mProgressBottom;
    @BindView(R.id.upgrade_progress_bar_top_filename) TextView mFileNameTop;
    @BindView(R.id.upgrade_progress_bar_bottom_filename) TextView mFileNameBottom;
    @BindView(R.id.ota_app_download) Button mAppDownload;
    @BindView(R.id.ota_app_stack_comb) Button mAppStackCombDownload;
    @BindView(R.id.ota_app_stack_seperate) Button mAppStackSepDownload;
    @BindView(R.id.progress_bar_top_rel_lay) RelativeLayout mProgBarLayoutTop;
    @BindView(R.id.progress_bar_bottom_rel_lay) RelativeLayout mProgBarLayoutBottom;
    ...
    private BroadcastReceiver mGattOTAStatusReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            synchronized (this) {
                ...
                Log.i("TAG","OTAFirmwareUpgrade mGattOTAStatusReceiver action="+ action);
                    ...
                    if (sharedPrefStatus.equalsIgnoreCase("" + BootLoaderCommands.ENTER_BOOTLOADER)) {
                        ...
                        if (extras.containsKey(Constants.EXTRA_SILICON_ID)
                            ...
                            if (siliconIDReceived.equalsIgnoreCase(mSiliconID) &&
                                ...
                                mProgressText.setText(getResources().getText(R.string.ota_get_flash_size));
                            } else {
                                /**
                                 * Wrong Silicon ID and SiliconRev
                                 */
                                showErrorDialogMessage(getResources().
                        ...
                        if (extras.containsKey(Constants.EXTRA_PROGRAM_ROW_STATUS)) {
                            ...
                            if (statusReceived.equalsIgnoreCase("00")) {
                                ...
                                mProgressText.setText(getResources().getText(R.string.ota_verify_row));
                            }
                        }
...
//                                Logger.e("Checksum received>> " + checksumReceived);
                                ...
                                if (fileCheckSumByte.equalsIgnoreCase(checksumReceived)) {
                                    ...
                                    showErrorDialogMessage(getResources().getString(
                        ...
                        if (extras.containsKey(Constants.EXTRA_VERIFY_CHECKSUM_STATUS)) {
                            ...
                            if (statusReceived.equalsIgnoreCase("01")) {
                                ...
                                mProgressText.setText(getResources().getText(R.string.ota_end_bootloader));
                            }
                        }
                        ...
                        final BluetoothDevice device = BluetoothLeService.mBluetoothAdapter
                                .getRemoteDevice(BluetoothLeService.getmDeviceAddress());

                        mProgressText.setText(getResources().getText(R.string.ota_end_success));
                        if (secondFileUpdatedNeeded()) {
                            mBuilder.setContentText(getResources().getText(R.string.ota_notification_stack_file))
                                    .setProgress(0, 0, false);
                            mNotificationManager.notify(mNotificationId, mBuilder.build());
                        } else {
                            mBuilder.setContentText(getResources().getText(R.string.ota_end_success))
                                    .setProgress(0, 0, false);
                            mNotificationManager.notify(mNotificationId, mBuilder.build());
                        }
                        ...
                        App.exit();
                        Intent it = new Intent(OTAFirmwareUpgradeActivity.this, MainActivity.class);
                        startActivity(it);
                    }
    ...
    public void initView(Bundle savedInstanceState) {
        ...
        mService=App.getmBluetoothGattService();
        Log.i("TAG","OTAFirmwareUpgradeActivity service ="+mService);
    ...
    public void onResume() {
        super.onResume();
        Log.i("TAG","enter OTAFirmwareUpgradeActivity");
        registerReceiver(mGattOTAStatusReceiver,
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.ota_upgrade_type_selection_logTv:
                Intent it = new Intent(OTAFirmwareUpgradeActivity.this,DataLoggerActivity.class);
    ...
    private void updateGUI(int updateOtion) {
        switch (updateOtion) {
            case mApplicationUpgrade:
                 ...
                 */
                Log.i("TAG","ota mApplication upgrade");
                ...
                mProgressText.setText(getResources().getText(R.string.ota_file_read));
    ...
    private void prepareFileWriting() {
        ...
        Log.i("TAG","ota mApplication upgrade finish");
    }
    ...
    public void onFileReadProgressUpdate(int fileLine) {
        ...
        if (mTotalLines == fileLine) {
            ...
            if (mOTACharacteristic != null) {
                ...
                mProgressText.setText(getResources().getText(R.string.ota_enter_bootloader));
    ...
    private String saveDeviceAddress() {
        String deviceAddress = BluetoothLeService.getmDeviceAddress();
        Utils.setStringSharedPreference(OTAFirmwareUpgradeActivity.this,
    ...
    private boolean secondFileUpdatedNeeded() {
        ...
        Log.i("TAG","bleservice.bleAddress="+BluetoothLeService.getmDeviceAddress());
        Log.i("TAG","saveDeviceAddress="+saveDeviceAddress());
        return BluetoothLeService.getmDeviceAddress().equalsIgnoreCase(saveDeviceAddress())
