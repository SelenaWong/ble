package com.evangeline.ble.view.loadingdrawable.render.circle.rotate;
...
import com.evangeline.ble.view.loadingdrawable.DensityUtil;
import com.evangeline.ble.view.loadingdrawable.render.LoadingRenderer;
...
public class LevelLoadingRenderer extends LoadingRenderer {
    ...
    private static final int[] DEFAULT_LEVEL_COLORS = new int[]{Color.parseColor("#5527b7f9"),
            Color.parseColor("#b127b7f9"), Color.parseColor("#ff27b7f9")};
