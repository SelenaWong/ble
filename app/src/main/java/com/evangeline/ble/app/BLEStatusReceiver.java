...
import com.evangeline.ble.OTAFirmwareUpdate.OTAFilesListingActivity;
import com.evangeline.ble.OTAFirmwareUpdate.OTAFirmwareUpgradeActivity;
import com.evangeline.ble.R;
import com.evangeline.ble.activity.DeviceControlActivity;
import com.evangeline.ble.activity.MainActivity;
import com.evangeline.ble.logActivity.DataLoggerHistoryList;
...
public class BLEStatusReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (Constants.ACTION_GATT_DISCONNECTED.equals(action)) {
            Logger.e("onReceive--" + MainActivity.mApplicationInBackground);
            if (!MainActivity.mApplicationInBackground
                ...
                if (OTAFirmwareUpgradeActivity.mFileupgradeStarted) {
                ...
                if (!MainActivity.mApplicationInBackground) {
                    ...
                    if (BluetoothLeService.getConnectState() == BluetoothLeService.STATE_DISCONNECTED) {
                        Toast.makeText(context,
                                context.getResources().getString(R.string.alert_message_bluetooth_disconnect),
                                Toast.LENGTH_SHORT).show();
