 ...
 */
public class GattDescriptorDetailsActivity extends BaseActivity implements
    ...
    private BroadcastReceiver mGattUpdateReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(Constants.ACTION_WRITE_SUCCESS)) {
                if (mGUIUpdateFlag) {
                    BluetoothLeService.readDescriptor(mDescriptor);
                    mGUIUpdateFlag = false;
                }
                Log.i("TAG","action write success");
            }
            if (action.equals(BluetoothDevice.ACTION_BOND_STATE_CHANGED)) {
                ...
                if (state == BluetoothDevice.BOND_BONDING) {
                    ...
                    Utils.bondingProgressDialog(GattDescriptorDetailsActivity.this, mProgressDialog, true);
                    ...
                    Utils.bondingProgressDialog(GattDescriptorDetailsActivity.this, mProgressDialog, false);
    ...
    public GattDescriptorDetailsActivity create() {
        GattDescriptorDetailsActivity fragment = new GattDescriptorDetailsActivity();
        return fragment;
    }
    ...
    public void initView(Bundle savedInstanceState) {
        setContentView(R.layout.activity_gattdb_descriptor_details);
        mApplication = (App) getApplication();
        mCharacteristicName = (TextView)findViewById(R.id.activity_gattdb_descriptor_details_cNameTv);
        mDescriptorName = (TextView)findViewById(R.id.activity_gattdb_descriptor_details_dNameTv);
        mDescriptorValue = (TextView)findViewById(R.id.activity_gattdb_descriptor_details_dvTxt);
        mHexValue = (TextView)findViewById(R.id.activity_gattdb_descriptor_details_dHvTxt);
        mBackBtn = (ImageView)findViewById(R.id.activity_gattdb_descriptor_details_imgback);

        mProgressDialog = new ProgressDialog(GattDescriptorDetailsActivity.this);
        ...
        mReadButton = (Button)findViewById(R.id.activity_gattdb_descriptor_details_readBtn);
        mNotifyButton = (Button)findViewById(R.id.activity_gattdb_descriptor_details_wNBtn);
        mIndicateButton = (Button)findViewById(R.id.activity_gattdb_descriptor_details_wIBtn);
    ...
    public void onResume() {
        super.onResume();
        Log.i("TAG","enter  GattDescriptorDetailsActivity");
        ...
        switch (view.getId()) {
            case R.id.activity_gattdb_descriptor_details_wNBtn:
                ...
                if (btnText.equalsIgnoreCase(mStopNotifyText)) {
                    ...
                    GattDetailsActivity.mIsNotifyEnabled = false;
                    btn.setText(mStartNotifyText);
                }
                break;
            case R.id.activity_gattdb_descriptor_details_wIBtn:
                ...
                if (btnTextIndicate.equalsIgnoreCase(mStartIndicateText)) {
                    ...
                    GattDetailsActivity.mIsIndicateEnabled = true;
                ...
                if (btnTextIndicate.equalsIgnoreCase(stopIndicateText)) {
                    ...
                    GattDetailsActivity.mIsIndicateEnabled = false;
                    btnIndicate.setText(mStartIndicateText);
                }
                break;
            case R.id.activity_gattdb_descriptor_details_readBtn:
                if (mDescriptor != null) {
                    BluetoothLeService.readDescriptor(mDescriptor);
                }
                break;
            case R.id.activity_gattdb_descriptor_details_imgback:
                onBackPressed();
                break;
        }
    }
